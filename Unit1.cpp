...
{
ShowMessage("Это проект, который реализует движение точек в определенном диапазоне исходя от осей, анимацию можно влючать и отключать");
}
//---------------------------------------------------------------------------

void __fastcall TForm1::Help1Click(TObject *Sender)
{
	 ShowMessage("Данный проект по машинной графике был откомпилирован студенткой группы 12001801 Воловиковой Анной Денисовной");
}
//---------------------------------------------------------------------------
